...
const DevResume: React.FC = () => {
	return (
		<Container>
			...
			<ResumeHeader title="Front-end web developer" />
			...
			<section className="experiences">
				...
				<div className="experience">
					...
					<ul className="description">
						...
						<li>
							I have been working as a <strong>full stack developer</strong> for
							about a year.
						</li>
						<li>A server, an e-commerce, and an admin system.</li>
						<li>
							Approximately <strong>1,500 clients</strong>.
						</li>
						<li>
							<strong>Authentication</strong> of sellers and clients with
							different accesses.
						</li>
						<li>
							Automatic <strong>e-mails</strong> using{' '}
							<strong>Google API's</strong>.
						</li>
						<li>
							<strong>PDF</strong> generation of requests.
						</li>
						<li>
							<strong>Spreadsheets</strong> for importing or exporting{' '}
							<strong>large</strong> amounts of data.
						</li>
						<li>
							<strong>PWA</strong> with <strong>offline</strong> functions and
							API <strong>synchronization</strong>.
						</li>
					</ul>
				...
				<div className="experience">
					...
					<ul className="description">
						...
						<li>
							Uses <strong>caching</strong> for media data using{' '}
							<strong>Redis</strong>.
						</li>
				...
				<div className="experience">
					<div className="header">
						<img
							src="https://raw.githubusercontent.com/iago-mendes/express-bot/main/public/logo.svg"
							alt="Express Bot"
						/>
						<h3>Express Bot</h3>
					</div>
					...
					<ul className="description">
						...
						<li>
							Solution to challenge created by <strong>VTEX</strong> in the{' '}
							<strong>hackathon</strong> BRASA Hacks.
						</li>
						<li>
							I worked in a <strong>group</strong> of 5 participants to create
							this in only <strong>4 days</strong>.
						</li>
						<li>
							From a total of 51 teams, my team won{' '}
							<strong>second place</strong>.
						</li>
						<li>
							Uses the <strong>Telegram Bot API</strong>.
						</li>
						<li>
							Personalized messages, smart search, and checkout without
							redirection.
						</li>
					</ul>
				...
				<div className="experience">
					...
					<ul className="description">
						...
						<li>
							Articles written in <strong>Markdown</strong>.
						</li>
						<li>
							<strong>OAuth 2.0</strong> authentication with{' '}
							<strong>Auth0</strong>.
						</li>
				...
				<div className="experience">
					<div className="header">
						<img
							src="https://textcounter.tools/faviconDark.svg"
							alt="Text Counter"
						/>
						<h3>Text Counter</h3>
					</div>
					...
					<ul className="description">
						...
						<li>
							<strong>Theme switcher</strong> (light or dark).
						</li>
						<li>
							Text show options and safe content in{' '}
				...
				<div className="experience">
					<div className="header">
						<img
							src="https://ceamontes-semana-astronomica-iago-mendes.vercel.app/favicon.svg"
							alt="2nd Astronomic Week"
						/>
					...
					<ul className="description">
						...
						<li>
							Step-by-step <strong>e-commerce</strong> experience.
						</li>
						<li>
							Uses <strong>Wide Pay</strong> as a{' '}
							<strong>payment gateway</strong> and stores data in{' '}
					...
					<ul className="links">
						<li>
							<FaLink />
							<ExternalLink
								url="https://ceamontes-semana-astronomica-iago-mendes.vercel.app/"
								text="ceamontes-semana-astronomica-iago-mendes.vercel.app"
							/>
						</li>
						<li>
							<FaGithub />
							<ExternalLink
								url="https://github.com/ceamontes/semana-astronomica"
								text="ceamontes/semana-astronomica"
							/>
						</li>
					</ul>
				</div>
